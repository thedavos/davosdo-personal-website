	...
	},
{
	...
	},
	{
		...
		slug: "rutasec",
		description:
			"Catálogo de aprendizaje de ciberseguridad con recursos curados, biblioteca personal y progreso sobre Cloudflare.",
		tags: ["TanStack Start", "Cloudflare", "D1", "Better Auth"],
		show: true,
		importance: "medium",
		status: "production",
		longDescription:
			"RutaSec ordena el aprendizaje de ciberseguridad convirtiendo recursos dispersos en un catálogo público fácil de explorar. El MVP se enfoca en descubrir recursos, abrir su detalle, iniciar sesión y guardarlos en una biblioteca personal, con una arquitectura sobre TanStack Start, server functions, Cloudflare Workers, D1 y Better Auth. La base de contenido arranca con Web Pentesting & Bug Bounty y separa teoría, práctica y recursos mixtos para que el aprendizaje tenga un camino más claro.",
		role: "Fullstack Developer & Creator",
		year: "2025 – presente",
		features: [
			"Catálogo público de recursos de ciberseguridad con atribución clara",
			"Detalle de recurso para revisar contenido antes de guardarlo",
			"Autenticación con email/password y sesiones usando Better Auth",
			"Biblioteca personal para guardar recursos",
			"Seed editorial con recursos de Web Pentesting & Bug Bounty",
			"Clasificación por tipo de recurso y modo de aprendizaje: teoría, práctica o mixto",
			"Flujo de propuesta de recursos desde issues de GitHub hacia seed JSON revisable",
		],
		stack: [
			{ category: "Frontend", items: ["TanStack Start", "TanStack Router", "React", "Tailwind CSS", "shadcn/ui"] },
			{ category: "Backend", items: ["Cloudflare Workers", "Server functions", "Better Auth"] },
			{ category: "Datos", items: ["Cloudflare D1", "Workers KV", "Seed JSON"] },
			{ category: "Observabilidad", items: ["Sentry"] },
			{ category: "Tooling", items: ["Vite+", "Wrangler", "Vitest", "Playwright"] },
		],
		links: [
			{ label: "RutaSec", url: "https://rutasec.space/", icon: "i-lucide-rocket", live: true },
			{ label: "Repositorio", url: "https://github.com/davosdo/rutasec", icon: "i-lucide-github" },
		],
		images: {
			hero: "/projects/rutasec/rutasec_home.webp",
			gallery: [
				"/projects/rutasec/rutasec_resource_proposal.webp",
				"/projects/rutasec/rutasec_resources_saved.webp",
			],
		},
	},
	{
		...
		year: "2026 – presente",
		features: [
			"Redirects personalizados con normalización, rutas reservadas, estados, expiración y caché en KV",
			"Autenticación single-user con Better Auth y registro público deshabilitado",
			"Panel para crear, editar, pausar, archivar y revisar enlaces cortos",
			"Organización mediante campañas, etiquetas y filtros de búsqueda o estado",
			"Analytics generales y por enlace con periodos de 7, 30 y 90 días o rango personalizado",
			"Comparación con el periodo anterior, zonas horarias y separación entre clics humanos y automatizados",
			"Desgloses por origen, país y dispositivo, rankings y actividad por día y hora",
			"Exportación CSV, diseño responsive, navegación por teclado y soporte para reduced motion",
		],
		stack: [
			{ category: "Frontend", items: ["TanStack Start", "React", "TypeScript", "TanStack Router", "Tailwind CSS"] },
			{ category: "Backend", items: ["Cloudflare Workers", "Better Auth", "Wrangler"] },
			{ category: "Datos y edge", items: ["Cloudflare D1", "Cloudflare KV", "Workers Analytics Engine"] },
			{ category: "Calidad", items: ["Vitest", "Testing Library", "TypeScript strict", "WCAG AA"] },
			{ category: "AI-assisted development", items: ["Codex", "Skills", "Subagentes", "Browser verification"] },
		],
		links: [
			{ label: "atajo", url: "https://links.davosdo.dev", icon: "i-lucide-rocket", live: true },
			{ label: "Repositorio", url: "https://github.com/thedavos/davos-links", icon: "i-lucide-github" },
			{ label: "Cómo lo construí", url: "https://davosdo.dev/blog/construyendo-atajo-con-codex", icon: "i-lucide-book-open" },
		],
		images: {
