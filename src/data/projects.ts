...
export const projects: ProjectDetail[] = [
{
		...
		slug: "interbank",
		description:
			"Iniciativas, flujos y productos relacionados con banca digital, experiencia financiera, operaciones bancarias e integraciones alrededor del ecosistema de Interbank.",
		tags: ["TypeScript", "Vue", "Angular", "CSS", "APIs"],
		show: true,
		importance: "high",
		status: "production",
		longDescription:
			"Participación directa en múltiples iniciativas de banca digital dentro del ecosistema de Interbank. Desarrollo de flujos de onboarding, operaciones bancarias (transferencias, pagos de servicios, recargas), dashboards financieros y módulos de experiencia de usuario orientados a la app móvil y web. Trabajo con equipos multidisciplinarios siguiendo metodologías ágiles, integraciones con APIs internas y externas, y foco constante en performance, accesibilidad y calidad de código.",
		role: "Frontend Developer",
		year: "2022 – 2023",
		features: [
			"Flujos de onboarding digital para nuevos clientes",
			"Dashboard de operaciones y movimientos bancarios",
			"Módulo de transferencias interbancarias e intrabancarias",
			"Integración con APIs de core bancario",
			"Sistema de pagos de servicios y recargas",
			"Optimización de performance y tiempos de carga",
		],
		stack: [
			{ category: "Frontend", items: ["Vue 3", "Angular", "TypeScript", "SCSS"] },
			{ category: "Herramientas", items: ["Vite", "Webpack", "Jest", "Cypress"] },
			{ category: "Backend / APIs", items: ["REST APIs", "GraphQL", "Node.js"] },
			{ category: "Infraestructura", items: ["AWS", "Jenkins", "Docker"] },
		],
		links: [
			{ label: "Interbank App", url: "https://interbank.pe", icon: "i-lucide-rocket", live: true },
		],
		images: {
			hero: "https://placehold.co/1200x600/1a1a2e/6366f1?text=Interbank+Hero",
			gallery: [
				"https://placehold.co/800x500/1a1a2e/6366f1?text=Dashboard",
				"https://placehold.co/800x500/1a1a2e/6366f1?text=Transferencias",
				"https://placehold.co/800x500/1a1a2e/6366f1?text=Onboarding",
			],
		},
	},
{
		...
		slug: "global66",
		description:
			"Iniciativas vinculadas a transferencias internacionales, productos financieros cross-border, billetera global e infraestructura fintech alrededor de Global66.",
		tags: ["TypeScript", "Vue", "NativeScript", "Tailwind", "APIs"],
		show: true,
		importance: "high",
		status: "production",
		longDescription:
			"Desarrollo de features para la plataforma fintech de transferencias internacionales Global66. Trabajo en la app móvil con NativeScript y en la plataforma web con Vue 3, implementando flujos de envío de dinero, verificación de identidad (KYC), billetera multi-moneda y dashboards de seguimiento de transacciones. Enfoque en UX fluida para un proceso financiero que requiere alta confianza del usuario, integraciones con proveedores de pago internacionales y cumplimiento regulatorio.",
		role: "Frontend Developer",
		year: "2023 – 2024",
		features: [
			"Flujo de transferencias internacionales paso a paso",
			"Sistema de verificación de identidad (KYC)",
			"Billetera multi-moneda con conversión en tiempo real",
			"Dashboard de seguimiento de transacciones",
			"App móvil con NativeScript para iOS y Android",
			"Sistema de notificaciones y alertas de tipo de cambio",
		],
		stack: [
			{ category: "Frontend", items: ["Vue 3", "TypeScript", "Tailwind CSS", "Pinia"] },
			{ category: "Mobile", items: ["NativeScript", "TypeScript"] },
			{ category: "Backend / APIs", items: ["REST APIs", "WebSockets", "Node.js"] },
			{ category: "Infraestructura", items: ["AWS", "GitHub Actions", "Docker"] },
		],
		links: [
			{ label: "Global66", url: "https://global66.com", icon: "i-lucide-rocket", live: true },
		],
		images: {
			hero: "https://placehold.co/1200x600/1a1a2e/6366f1?text=Global66+Hero",
			gallery: [
				"https://placehold.co/800x500/1a1a2e/6366f1?text=Transferencias",
				"https://placehold.co/800x500/1a1a2e/6366f1?text=Billetera",
				"https://placehold.co/800x500/1a1a2e/6366f1?text=Mobile+App",
			],
		},
	},
	{
